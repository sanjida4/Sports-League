...
const LeagueDetail = () => {
    ...
    // let gender = league[0].strGender;
    // let imageURL = '';
    // const gender2 = gender? imageURL = "https://media.npr.org/assets/img/2019/01/02/gettyimages-1058306908-0b38ff8a90d7bf88fea3133d8b72498665f63e12.jpg" :
    // imageURL = "https://img.olympicchannel.com/images/image/private/t_social_share_thumb/primary/djnacbhtd6zvpkdiixah";
    ...
    return (
        <div>
                    ...
                    <div>
                        <div className="hero-image">
                            <div className="overlay">
                                <h3 style={{background: 'none'}}>{league[0].strLeague}</h3>
                            </div>
                        </div>
                        <div style={{margin: '3% 10%'}}>
                            <div style={{ border: '2px solid lightgreen', borderRadius: '10px', marginTop: '30px', padding: '30px', display: 'flex'}}>
                                ...
                                <div>
                                    <img style={{marginLeft: '60%', borderRadius: '10px'}} src={imageURL} alt="" height="250px" width ='600px'/>
                                </div>
                            </div>
                        </div>
                ...
                <div style={{justifyContent: 'center', alignItems: 'center', fontSize: '45px', display: 'flex', padding: '20px'}}>
